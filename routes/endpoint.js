...
var getResponse = (body) => {
  ...
  if (typeof data !== "object" && typeof rule !== "object") {
  ...
  var fn = anotherFn(body);

  return ruleHandler(fn, body);
};
...
var ruleHandler = ({ condition, value1, value2 }, body) => {
  var sign = conditionSign(condition);
  // perform the operation
  return performOperation(sign, value1, value2, body);
};
