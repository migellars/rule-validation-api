...
const errorType = {
  ...
  ERROR_TYPE_WRONG_TYPE: (field, type) =>
    `[${field}] should be a|an [${type}].`,
  ERROR_TYPE_INVALID_RULE_DATA_TYPE: "rule should be an object.",
  ERROR_TYPE_MISSING_FIELD_FROM_DATA:
    (field)=>`field [name of field] is missing from data.`,
};
